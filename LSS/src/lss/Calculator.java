...
public class Calculator implements Common {
...

    {
        ...
        st_data[P][BASE][CHA] = 11;
        st_data[P][REM][STR] = 7;                                               //20(初期最大値)
        st_data[P][REM][DEX] = 9;                                               //18
        st_data[P][REM][INT] = 9;                                               //18
        st_data[P][REM][WIS] = 9;                                               //20
        st_data[P][REM][CON] = 9;                                               //20
        st_data[P][REM][CHA] = 9;                                               //20
        rem_data[P] = 11;
        ...
        st_data[K][REM][STR] = 4;                                               //20
        st_data[K][REM][DEX] = 4;                                               //16
        st_data[K][REM][INT] = 4;                                               //12
        st_data[K][REM][WIS] = 4;                                               //13
        st_data[K][REM][CON] = 4;                                               //20
        st_data[K][REM][CHA] = 4;                                               //14
        rem_data[K] = 4;
        ...
        st_data[E][REM][STR] = 8;                                               //18
        st_data[E][REM][DEX] = 8;                                               //20
        st_data[E][REM][INT] = 8;                                               //20
        st_data[E][REM][WIS] = 8;                                               //20
        st_data[E][REM][CON] = 8;                                               //20
        st_data[E][REM][CHA] = 8;                                               //17
        rem_data[E] = 8;
        ...
        st_data[W][REM][STR] = 12;                                              //20
        st_data[W][REM][DEX] = 12;                                              //19
        st_data[W][REM][INT] = 6;                                               //20
        st_data[W][REM][WIS] = 6;                                               //20
        st_data[W][REM][CON] = 8;                                               //20
        st_data[W][REM][CHA] = 12;                                              //20
        rem_data[W] = 12;
        ...
        st_data[D][BASE][CHA] = 7;
        st_data[D][REM][STR] = 5;                                               //20
        st_data[D][REM][DEX] = 7;                                               //19
        st_data[D][REM][INT] = 7;                                               //18
        st_data[D][REM][WIS] = 7;                                               //17
        st_data[D][REM][CON] = 8;                                               //20
        st_data[D][REM][CHA] = 8;                                               //15
        rem_data[D] = 8;
        ...
        st_data[R][REM][STR] = 7;                                               //20
        st_data[R][REM][DEX] = 9;                                               //20
        st_data[R][REM][INT] = 9;                                               //19
        st_data[R][REM][WIS] = 9;                                               //19
        st_data[R][REM][CON] = 6;                                               //20
        st_data[R][REM][CHA] = 9;                                               //17
        rem_data[R] = 9;
        ...
        st_data[I][REM][STR] = 10;                                              //19
        st_data[I][REM][DEX] = 10;                                              //20
        st_data[I][REM][INT] = 8;                                               //20
        st_data[I][REM][WIS] = 6;                                               //20
        st_data[I][REM][CON] = 8;                                               //20
        st_data[I][REM][CHA] = 10;                                              //18
        rem_data[I] = 10;
        ...
        st_data[S][REM][STR] = 4;                                               //20
        st_data[S][REM][DEX] = 4;                                               //17
        st_data[S][REM][INT] = 4;                                               //14
        st_data[S][REM][WIS] = 4;                                               //11
        st_data[S][REM][CON] = 4;                                               //20
        st_data[S][REM][CHA] = 4;                                               //13
        rem_data[S] = 4;
        ...
        st_data[F][REM][STR] = 4;                                               //20
        st_data[F][REM][DEX] = 4;                                               //17
        st_data[F][REM][INT] = 4;                                               //15
        st_data[F][REM][WIS] = 4;                                               //15
        st_data[F][REM][CON] = 4;                                               //19
        st_data[F][REM][CHA] = 4;                                               //9
        rem_data[F] = 4;
        ...
        st_data[L][REM][STR] = 6;                                               //20
        st_data[L][REM][DEX] = 6;                                               //18
        st_data[L][REM][INT] = 6;                                               //15
        st_data[L][REM][WIS] = 6;                                               //18
        st_data[L][REM][CON] = 4;                                               //20
        st_data[L][REM][CHA] = 6;                                               //12
        rem_data[L] = 6;
        ...
        _C[HP][CON][P] = 13;        //2460
        _C[HP][CON][K] = 16;        //2825 再検証必要
        _C[HP][CON][E] = 12;        //2188
        _C[HP][CON][W] = 6;         //1396
        _C[HP][CON][D] = 13;        //2283 再検証必要
        _C[HP][CON][R] = 17;        //2728
        _C[HP][CON][I] = 10;        //1930 再検証必要
        _C[HP][CON][S] = 16;        //2900
        _C[HP][CON][F] = 14;        //2188
        _C[HP][CON][L] = 26;        //3172
    ...
    private double acc = 1.0;                                                   //1段加速(GP GGP ワイン ウイスキー)
    double acc_1 = 1.3333;                                                      //2段加速(BP イビルブラッド ブラッドラスト 名誉のコイン ダンシングブレイズ フォーカスウェーブ ハリケーン サンドストーム)
    double acc_2 = 1.3333;                                                      //2段加速(EW 濃縮集中ポーション ムービングアクセレーション:マキシマム)
    double acc_ew = 1.1547;                                                     //2段加速(ダークホース)
    double acc_df = 1.0800;                                                     //3段加速(ドラゴンブラッド 蔵出し秘蔵酒)
    double acc_3 = 1.125;                                                       //4段加速(マジックドールの潜在力)
    double acc_4 = 1.100;                                                       //5段加速(騎士技術(レイジング ウェポン))
...
//君主魔法（プリンス・プリンセス)
        ...
        //エンパイア:オーバーロード
        ui.cb_buff[P_EOD].setToolTipText("<html>"+ "[消費MP:--][消費HP:--]"
                                         + "<br>"+ "エンパイアのスタン時間増加"
                                         + "<br>"+ "スタン中、DG-10デバフ発動"
                                         + "<br>"+ "[習得レベル:80][持続時間:Passive][対象:術者]"+"</html>");
        if (ui.cb_buff[P_EOD].isSelected()) {
        //スキル効果未実装
        }
        ...
        //シャイニングシールド
        ui.cb_buff[P_SSD].setToolTipText("<html>"+ "[消費MP:20][消費HP:--]"
        ...
        //ランカーボーナス
        //STR+1[君主][ナイト][ダークエルフ][ドラゴンナイト][ウォリアー][フェンサー][ランサー]/DEX+1[エルフ]/INT+1[ウィザード][イリュージョニスト]
...
//                        + (1.0 - buki.double_hit_rate);
       ...
       //エレメンタルファイアー
        ...
        //ブレイブメンタル
        ui.cb_buff[P_BML].setToolTipText("<html>"+ "[消費MP:20][消費HP:--]"
        ...
        ui.lab_dmg_short.setText("基本ダメージ(近) : " + base_dmg_short);
        ui.lab_dmg_long.setText("基本ダメージ(遠) : " + base_dmg_long);
        ui.lab_dmg_mag.setText("基本ダメージ(魔) : " + base_dmg_magic);
