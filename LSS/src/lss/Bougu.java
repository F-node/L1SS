...
//ゲートル
        ...
        //バルーガのゲートルは+8から+1強化毎にダメージ低下の効果が+1ずつ増加
        if (name.equals("バルーガのゲートル")) {
            if (enchant >= 8) {
                op2.DR = enchant-7;                                                     //近距離命中+6
            }
        }
//スポールダー
